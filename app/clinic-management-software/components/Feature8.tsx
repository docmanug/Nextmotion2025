        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-1 lg:order-1">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Integration center</h2>
            </div>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-[20px] font-bold text-gray-900 mb-3">Mailchimp, Brevo & HubSpot</h3>
                <p className="text-[18px] leading-relaxed text-gray-600">
                  Automate marketing campaigns, schedule communications, and track patient engagement with smooth 
                  integrations with these CRM platforms.
                </p>
              </div>
              
              <div>
                <h3 className="text-[20px] font-bold text-gray-900 mb-3">Stripe</h3>
                <p className="text-[18px] leading-relaxed text-gray-600">
                  Simplify online payments with Stripe, providing your patients with a secure and fast way to pay 
                  for consultations directly through the online booking system.
                </p>
              </div>
              
              <div>
                <h3 className="text-[20px] font-bold text-gray-900 mb-3">Zapier</h3>
                <p className="text-[18px] leading-relaxed text-gray-600">
                  Connect over 8,000 apps to Nextmotion, allowing you to further customize workflows and automate 
                  repetitive tasks like appointment reminders or resource management.
                </p>
              </div>
