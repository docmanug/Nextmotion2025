        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h2 className="text-2xl sm:text-[2.5rem] font-bold text-[#081F4D] mb-4 sm:mb-5 leading-tight">
              A new chapter opens in the aesthetic industry
            </h2>

            {/* Content Paragraphs */}
            <div className="space-y-4 sm:space-y-6 text-[#081F4D]">
              <p className="text-base sm:text-lg leading-relaxed">
                Introducing <span className="font-semibold">LENA</span> (
                <span className="font-semibold">L</span>ight{" "}
                <span className="font-semibold">E</span>nabled{" "}
                <span className="font-semibold">N</span>euro-robotic{" "}
                <span className="font-semibold">A</span>rm), our latest
              ...
              <p className="text-base sm:text-lg leading-relaxed">
                The localization of the injection points as well as their depth
                will be perfectly achieved thanks to its medical robotic arm
