      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-48">
        <div className="max-w-xl">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4 sm:mb-6 leading-tight">
            The world's first autonomous injector robot with AI for aesthetic
            medicine
          </h1>
          <p className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8">
            Meet LENA, the first injector robot self-piloted with artificial
            intelligence, dedicated to aesthetic medicine
          </p>
          <Link
