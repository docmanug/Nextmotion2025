    ...
    <section className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 group">
          {/* Teacher Card */}
          <div className="bg-[#F8FAFC] rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-opacity duration-300 hover:opacity-100 group-hover:opacity-50 hover:!opacity-100">
