    ...
    <section className="py-24 bg-[#F8FAFC]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          Discover Nextmotion Capture and Nextmotion 3D to directly integrate perfectly standardized photos into your patient records
          and significantly enhance the quality of your consultations.
          </p>
        </div>
