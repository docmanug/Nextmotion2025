...
export default function Feature6() {
  ...
  const t = useTranslations(messages?.marketingPage?.feature6 || {});
          ...
          <div className="order-2 lg:order-1">
            <div className="relative flex items-center justify-center">
              <div className="relative">
                <OptimizedImage
                  src="/marketing/marketing_6.webp"
                  alt={t("imageAlt")}
                  width={800}
                  height={1000}
          ...
          <div className="order-1 lg:order-2">
            <div className="flex items-center gap-4 mb-4 sm:mb-6">
              <div className="bg-blue-100 rounded-full p-2 sm:p-3">
                <OptimizedImage
                  src="/marketing/icons/marketing_6_icon.webp"
                  alt={t("imageAlt")}
                  width={60}
                  height={60}
            ...
            <div className="space-y-6 sm:space-y-8">
              {Array.isArray(messages?.marketingPage?.feature6?.sections) &&
                messages.marketingPage.feature6.sections.map(
