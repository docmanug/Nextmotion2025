...
export default function Hero() {
  ...
  const t = useTranslations(messages?.chainesPage?.hero || {});
        ...
        <div className="flex flex-col items-start gap-6 sm:gap-8 pt-0 pb-8 sm:pb-16">
          <div className="flex flex-col items-start gap-4 sm:gap-6 max-w-[700px]">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                <Button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-base px-8 py-3 h-auto rounded-full">
                  {t("button")}
                </Button>
              </Link>
              <Link
