...
export const metadata: Metadata = {
  title: 'All-in-one software for aesthetic clinics | Nextmotion',
  description: 'Manage your patients, digitize your consultations, and grow your revenue with a SaaS solution designed for aesthetic medicine.',
  alternates: {
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link href="/pricing-aesthetic-solution">
