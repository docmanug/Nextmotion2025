  ...
  return (
    <main>
      ...
      <ApprovalSection
        ...
        resources={{
          ebook: {
            type: t("approval.resources.ebook.type"),
            title: t("approval.resources.ebook.title"),
          },
          social: {
            type: t("approval.resources.social.type"),
            title: t("approval.resources.social.title"),
          },
          events: {
            type: t("approval.resources.events.type"),
            title: t("approval.resources.events.title"),
          },
        }}
        discoverButton={t("approval.discoverButton")}
      />
      <Footer
        professional={{
