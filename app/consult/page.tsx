...
export const metadata: Metadata = {
  title: 'Nextmotion Consult v2 - AI-Powered Patient Management',
  description: 'Revolutionary AI-powered consultation management system for aesthetic clinics. Streamline patient care, automate documentation, and boost efficiency.',
  alternates: {
    canonical: 'https://www.nextmotion.net/consult',
  },
};
...
export default async function ConsultPage() {
  ...
  const contactFormLink = '/contact_form';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="https://youtu.be/5ppBRo2iFYg" target="_blank" rel="noopener noreferrer">
                  <Button
                    size="lg"
                    variant="outline"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {t('features.items').map((feature: string, index: number) => {
              ...
              return (
                <div key={index} className="group relative bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <div className={`absolute inset-0 bg-gradient-to-t ${gradientColors[index]} opacity-20`} />
                  ...
                  <div className="relative p-6">
                    <div className="flex items-start">
                      <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${gradientColors[index]} mr-3 mt-2 flex-shrink-0`} />
                      <p className="text-gray-700 text-base leading-relaxed group-hover:text-gray-900 transition-colors">
                        {feature}
                      </p>
                    </div>
                    
                    <div className={`absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r ${gradientColors[index]} group-hover:w-full transition-all duration-500`} />
                  </div>
                </div>
              );
            })}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="text-3xl font-bold text-purple-600 mb-3">-70%</div>
              <p className="text-gray-700 text-sm">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10 justify-center">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all duration-300 group h-full">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <span className="font-semibold text-white mb-1">Agenda</span>
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all duration-300 group h-full">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <span className="font-semibold text-white mb-1">Capture</span>
                      <p className="text-blue-100 text-xs">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-bold text-gray-900">{t('testimonials.author')}</div>
