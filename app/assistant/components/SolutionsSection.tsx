      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-gray-600 max-w-5xl mx-auto">
            Nextmotion is Specifically Designed for the Needs of Aesthetic
            Clinic Assistants and Secretaries : discover how our solution helps
            you save time, reduce administrative tasks, and improve your
            clinic’s overall efficiency.
          </p>
        </div>
